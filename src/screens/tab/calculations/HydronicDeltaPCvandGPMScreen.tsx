...
const HydronicDeltaPCvandGPMScreen = () => {
      ...
      <View style={styles.headerContainer}>
        <Surface style={styles.header}>
          <View style={styles.headerGradient}>
            <Title style={styles.headerTitle}>Cv and GPM</Title>
            <Paragraph style={styles.headerSubtitle}>
              Calculate flow rate and valve coefficient using Cv formula
            </Paragraph>
          </View>
        </Surface>
      </View>
...
export default HydronicDeltaPCvandGPMScreen;
