...
const HydronicPumpLawsBrakeHorsepowerScreen = () => {
  ...
  const calculateMissingValue = () => {
    const values = [waterHorsepower, pumpEfficiency, brakeHorsepower];
      ...
      <View style={styles.headerContainer}>
        <Surface style={styles.header}>
          <View style={styles.headerGradient}>
            <Title style={styles.headerTitle}>Brake Horsepower</Title>
            <Paragraph style={styles.headerSubtitle}>
              Calculate brake horsepower based on water horsepower and pump efficiency
            </Paragraph>
          </View>
        </Surface>
      </View>
        ...
        <Surface style={styles.liquidCard}>
          <View style={styles.cardContent}>
            <View style={styles.formulaContainer}>
              ...
              <Text style={styles.formulaText}>BHP = WHP / Efficiency</Text>
              <Paragraph style={styles.formulaDescription}>
                Where: BHP = Brake Horsepower, WHP = Water Horsepower, Efficiency = Pump Efficiency (%)
              </Paragraph>
            </View>
            ...
            {(waterHorsepower || pumpEfficiency || brakeHorsepower) && (
...
export default HydronicPumpLawsBrakeHorsepowerScreen;
