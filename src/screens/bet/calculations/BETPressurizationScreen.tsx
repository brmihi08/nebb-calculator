...
const BETPressurizationScreen = () => {
  ...
  const calculateMissingValue = () => {
    ...
    if (airflowRate === '') {
      ...
      // This is more complex - typically requires multiple data points
  ...
  const calculateUncertainty = () => {
    ...
    const u_Q_measured = airflowUncertainty ? parseFloat(airflowUncertainty) : q * 0.03; // Default 3% uncertainty
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: '#f0f8f0' }]}>
      <View style={styles.headerContainer}>
        <Surface style={styles.header}>
          <View style={styles.headerGradient}>
            <Title style={styles.headerTitle}>ASTM E779 Pressurization</Title>
            <Paragraph style={styles.headerSubtitle}>
              Calculate air leakage rate from pressurization test data using Q = C × (ΔP)^n
            </Paragraph>
          </View>
        </Surface>
      </View>
      ...
      <View style={styles.section}>
        <Surface style={styles.liquidCard}>
          <View style={styles.cardContent}>
            <Title style={styles.infoTitle}>ASTM E779 Notes</Title>
            ...
            <Paragraph style={styles.infoText}>
              • Measurement uncertainty follows ASTM E779 guidelines
            </Paragraph>
            <Paragraph style={styles.infoText}>
...
export default BETPressurizationScreen;
