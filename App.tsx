...
import { Provider as PaperProvider, DefaultTheme, MD2DarkTheme as PaperDarkTheme, useTheme } from 'react-native-paper';
...
const appleGlassTheme = {
  ...
  colors: {
    ...
    background: '#0a0a0a',        // Dark gray background
    surface: '#1a1a1a',  // Solid dark surface
    surfaceVariant: '#252525', // Lighter surface
    ...
    // Elevation/Shadow colors - solid for better visibility
    elevation: {
      level0: 'transparent',
      level1: '#1a1a1a',
      level2: '#252525',
...
// Shared dark stack screen options (used by all stacks)
